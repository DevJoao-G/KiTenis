            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4">
                        ...
                        <button class="btn btn-success w-100 fw-semibold mb-2" type="button"
                        ...
                        <form id="checkoutForm" novalidate>
                            ...
                            <div class="checkout-step-pane is-visible" data-pane="0">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="buyer_cpf" placeholder="Somente números" inputmode="numeric" required>
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label fw-semibold">Celular <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="buyer_phone" placeholder="DDD + número" inputmode="numeric" required>
                                    </div>
                            ...
                            <div class="checkout-step-pane" data-pane="1">
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" name="ship_cep" placeholder="00000000" inputmode="numeric" required>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" name="ship_complement" placeholder="Ex: Apto 12, Bloco B">
                                    </div>
                            ...
                            <div class="checkout-step-pane" data-pane="2">
                                ...
                                <div class="mt-3" id="paymentPaneCard">
                                    <div class="row g-3">
                                        <div class="col-12">
                                            <label class="form-label fw-semibold">Número do Cartão <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="card_number" placeholder="0000 0000 0000 0000" inputmode="numeric">
                                        </div>

                                        <div class="col-md-6">
                                            <label class="form-label fw-semibold">Validade <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="card_exp" placeholder="MM/AA" inputmode="numeric">
                                        </div>

                                        <div class="col-md-6">
                                            <label class="form-label fw-semibold">CVV <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="card_cvv" placeholder="123" inputmode="numeric" maxlength="4">
                                        </div>

                                        <div class="col-12">
                                            <label class="form-label fw-semibold">Nome no Cartão <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="card_name" placeholder="NOME COMO NO CARTÃO">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-3 d-none" id="paymentPaneBoleto">
                                    <div class="row g-3">
                                        <div class="col-12">
                                            <label class="form-label fw-semibold">E-mail para envio do boleto <span class="text-danger">*</span></label>
                                            <input type="email" class="form-control" name="boleto_email" placeholder="seuemail@exemplo.com">
                                        </div>
                                    </div>
                                </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function validateStep2() {
        ...
        // PIX: no UI mínimo, sem campos obrigatórios
        return true;
    }
    ...
    function bindCheckout() {
        ...
        // Seleção pagamento (sem laranja: sempre success)
        paymentOptions.forEach((opt) => {
        ...
        checkoutForm.addEventListener('submit', (e) => {
            ...
            // Integração com API vem na próxima etapa
            showFlash('success', 'Pedido pronto para integrar com pagamento (API).');
