        ...
        @if (empty($items))
            <div class="card border-0 shadow-sm" id="cartEmptyBox">
                <div class="card-body p-4">
                    <div class="fw-semibold mb-1">Seu carrinho está vazio.</div>
                    <div class="text-muted mb-3">
                        Adicione um produto e volte aqui para finalizar a compra.
                    </div>
...
@push('scripts')
    <script>
        window.__checkoutErrors = @json($errors->all());
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function showToast(type, message) {
                ...
                el.innerHTML = `
                    <div class="toast-header">
                        <i class="bi ${toastIcon(type)} me-2 text-${type}"></i>
                        <strong class="me-auto">${toastTitle(type)}</strong>
            ...
            function ensureEmptyBox() {
                ...
                box.className = 'card border-0 shadow-sm';
                box.id = 'cartEmptyBox';
                box.innerHTML = `
                    <div class="card-body p-4">
                        <div class="fw-semibold mb-1">Seu carrinho está vazio.</div>
                        <div class="text-muted mb-3">Adicione um produto e volte aqui para finalizar a compra.</div>
                        <a class="btn btn-success" href="{{ route('products.index') }}">
                            <i class="bi bi-shop me-1"></i> Ver produtos
                        </a>
                    </div>
            ...
            function bindCheckout() {
                ...
                btnNext1?.addEventListener('click', () => {
                    ...
                    else showFlash('warning', 'Confira os campos dos dados pessoais.');
                });
                ...
                btnNext2?.addEventListener('click', () => {
                    ...
                    else showFlash('warning', 'Confira os campos de entrega.');
                });
                ...
                checkoutForm.addEventListener('submit', (e) => {
                    ...
                    if (!ok0) {
                        e.preventDefault();
                        setStep(0);
                        showFlash('warning', 'Confira os campos dos dados pessoais.');
                        return;
                    }
                    ...
                    if (!ok1) {
                        e.preventDefault();
                        setStep(1);
                        showFlash('warning', 'Confira os campos de entrega.');
                        return;
                    }
